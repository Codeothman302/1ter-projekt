...
print(f"Hello {name} the game will start in 5 seconds ")
...
widow_width = window.winfo_width()
window_height = window.winfo_height()
screen_width = window.winfo_screenwidth()
screen_height = window.winfo_screenheight()

x = int((screen_width/2) - (widow_width/2))
y = int((screen_height/2) - (window_height/2))

window.geometry(f"{widow_width}x{window_height}+{x}+{y}")
